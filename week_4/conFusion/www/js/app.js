...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  // added $ionicConfigProvider
  // and $ionicConfigProvider.scrolling.jsScrolling(true);
  // to get rid of the scrollbar in the android version
      ...
      'mainContent': {
        ...
        resolve: {
          ...
          leader: ['corporateFactory', function(corporateFactory){
            return corporateFactory.get({id: 3}); // probably can or should be changed:
